                            ...
                            <div class="card-box">
                                ...
                                <form name="form" id="form" method="post" class="form-horizontal" onsubmit="" role="form" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" placeholder="วว/ดด/ปป.." id="datepicker-autoclose" data-date-format="yyyy-mm-dd" type="datetime" name="car_exmination_date" required class="form-control" value="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="name" type="text" name="car_company_owned" placeholder=" " required class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hori-pass" class="col-sm-2 col-form-label">วันที่ประกันหมดอายุ</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" placeholder="วว/ดด/ปป.." id="datepicker-autoclose" data-date-format="yyyy-mm-dd" type="text" name="car_expiration_date" required class="form-control">
                                        </div>
                                        <label for="hori-pass1" class="col-sm-2 col-form-label">วันที่ภาษีหมดอายุ</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" placeholder="วว/ดด/ปป.." id="datepicker-autoclose" data-date-format="yyyy-mm-dd" type="text" name="car_tax_expirationdate" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                ...
                $.ajax({
                    ...
                    success: function() {
                        swal(
                            ...
                            window.location.href = 'counter_allcar.php';
                        });
                    }
                });
            });
